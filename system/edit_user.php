  ...
  <form name="addform" id="addform" action="?act=ok" method="post">
    <table cellpadding=0 cellspacing=0 class="table_form" width="100%">
	  ...
	  <tr>
        <td width="10%" >姓 名</td>
        <td width="90%" >
          <input type="text" class="input-text" name="name"  id="name"  size="55" value="<?php echo $e_rs['name'];?>" /><input name="id" type="hidden" value="<?php echo $sxid;?>" /> <font color="red">*</font>
          </td>
      </tr>
      <tr>
        <td width="10%" >密 码</td>
        <td width="90%"><input type="text" name="pwd" class="input-text" size="55" id="pwdd"/> <font color="#FF0000"><strong>[不修改请留空]</strong></font></td>
      </tr>
      <tr>
        <td width="10%" >重复密码</td>
        <td width="90%"><input type="text" name="re_pwd" class="input-text" size="55" id="repwdd" /></td>
      </tr>
    </table>
    <div id="bootline"></div>
