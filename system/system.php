...
<div class="mainbox">
  ...
  <div id="coprights" class="list">
    ...
    <ul>
      <li><span>程序版本:</span>1.1.0</li>
      <li><span>技术支持:</span><b id="sn">E-MAIL: starpixel@starpixel.club | 1163246049@qq.com(推荐) | xiaoyong@starpixel.club</b></li>
      <li><span>程序说明:</span><b id="update">此程序版权归开发者拥有，任何单位或者个人不得作为商业用途！</b></li>
      <li><span>官方网站:</span><b><a href="http://ly.starpixel.club/" target="_blank" class="lya">http://pms.starpixel.club/</a></b></li>
</li>
      <li></li>
      <li><span>当前版本:</span><b>测试版</b></li>
    </ul>
  </div>
</div>
</body>
