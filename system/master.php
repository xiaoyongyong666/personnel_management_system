...
?>
  ...
  <div class="nav f_r"> </i> 制作: <a href="http://starpixel.club" target="_blank">泳&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div>
  ...
  <div class="topmenu">
    <ul>
      ...
      <li id='menu_2'><span><a href='javascript:void(0);' onClick='sethighlight(2);'>人员管理</a></span></li>
	  <?php
	if ($userinfos['type']=='9'){
		echo ("
  ...
  <div id="leftMenuBox">
    <div id="leftMenu">
	  ...
	  ?>
        ...
        <dl id="nav_2">
          <dt>人员管理</dt>
          <dd id="nav_21"><span><a href="manage_person.php" target="main">人员管理</a></span></dd>
		  <?php
		if ($userinfos['type']=='9'){
		echo ("
          <dd id='nav_22'><span><a href='manage_book_class.php' target='main'>留言分类</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='add_bo_class.php' id='' target='main'>添加</a></span></dd>
		"); }
		  ?>
        </dl>
		<?php
...
?>
<div id="footer" class="footer">Powered by <?php echo $Companyname;?>&nbsp; Released&nbsp;Copyright <?php echo '&copy; ' . autoUpdatingCopyright(2022);?> 作者：xiaoyong QQ:1163246049</div>
</body>
</html>